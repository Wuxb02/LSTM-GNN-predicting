...
基于图神经网络（GNN）的华南地区日最高气温预测系统，覆盖28个气象站，数据跨度2010–2019年。
...
gnn_predict/
├── data/
│   ├── result/                          # CSV原始数据（2010-2019年，10个文件）
...
### 主数据 `real_weather_data_2010_2019.npy`

形状：`[3652, 28, 29]`（天数 × 站点数 × 特征数）
...
| 集合 | 年份 | 索引范围 | 天数 |
|------|------|----------|------|
| 训练集 | 2010–2017 | 0–2921 | 2922 |
| 验证集 | 2018 | 2922–3286 | 365 |
| 测试集 | 2019 | 3287–3651 | 365 |
